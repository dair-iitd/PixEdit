    ...
    def model_fn(x, t_continuous):
        ...
        if guidance_type == "uncond":
            ...
            if guidance_scale == 1. or unconditional_condition is None:
                ...
                c_in = torch.cat([condition, unconditional_condition, unconditional_condition])

                noise_cond, noise_img_cond, noise_uncond = noise_pred_fn(x_in, t_in, cond=c_in).chunk(3)
                return noise_uncond + guidance_scale * (noise_cond - noise_img_cond) + img_guidance_scale*(noise_img_cond - noise_uncond)
